            ...
            if(!$productos){
                ...
                echo '<ul class="grid0">';
                    ...
                    foreach ($productos as $key => $value) {
                        ...
                        echo '<li class="col-md-3 col-sm-6 col-xs-12 cuadro">
                                <figure>
                                ...
                                <h4>
                                    <small>
                                        ...
                                        <a href="'.$value["ruta"].'" class="pixelProducto text-uppercase">
                        ...
                        echo '<li class="col-sx-12">
                                ...
                                <div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
                                    ...
                                    if($value["precio"] == 0){
                                        ...
                                        echo '<h2 class="oflist"><small>GRATIS</small></h2>';

                                    }else{
                                        
                                        if($value["oferta"] != 0){

                                                echo '<h2 class="oflist">
                                            ...
                                            echo '<h2 class="oflist"><small>USD $'.$value["precio"].'</small></h2>';
            ...
            <center>
                ...
                if (count($listaProductos) != 0) {
                    ...
                    if($pagProductos > 4){
                        ...
                        /*-------------------------------------------------
                        Botones de las 1eras 4 páginas y la última página 
                        -------------------------------------------------*/
                        ...
                        /*----------------------------------------------
                            Botones de la mitad páginas hacia abajo
                        ----------------------------------------------*/
                        ...
                        /*----------------------------------------------
                            Botones de la mitad páginas hacia arriba
                        ----------------------------------------------*/
                        else if($rutas[1] != $pagProductos && $rutas[1] != 1 && $rutas[1] >= ($pagProductos/2) && $rutas[1] < ($pagProductos-3)){
                        ...
                        /*-------------------------------------------------
                        Botones de las últimas 4 páginas y la 1era página 
                        -------------------------------------------------*/
                        else{
                            ...
                            for ($i = ($pagProductos-3); $i <= $pagProductos; $i++) { 
                                ...
                                echo '<li id="item'.$i.'/'.$rutas[2].'/'.$rutas[3].'"><a href="'.$url.$rutas[0].'/'.$i.'/'.$rutas[2].'/'.$rutas[3].'">'.$i.'</a></li>';
                        ...
                        for ($i=1; $i <= $pagProductos; $i++) { 
                            ...
                            echo '<li id="item'.$i.'/'.$rutas[2].'/'.$rutas[3].'"><a href="'.$url.$rutas[0].'/'.$i.'">'.$i.'</a></li>';
